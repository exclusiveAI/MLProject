...
ea = EarlyStoppingCallback(patience_limit=100)
values = [0.001, 0.0001]
...
myconfigurator = ConfiguratorGen(random=False, regularizations=values2, learning_rates=values,
                                 ...
                                 number_of_units=[10], number_of_layers=[1, 2, 3],
                                 momentums=[0.9, 0.5, 0.1, 0.01], initializers=[uniform], input_shapes=train.shape, verbose=False,
...
model.train(train, train_label, test, test_label, epochs=1000)
