...
class InputLayer(Layer):
    ...
    def backpropagate(self, **kwargs):
        ...
        input = mps.array(np.insert(self.input, 0, 1, axis=-1))
        ...
        self.error = mps.multiply(self.activation_func.derivative(self.nets), self.error)
        return mps.multiply(input.T, self.error)
